$(function() {
    ...
    i.on("click", function(a) {
        ...
        0 === $(a.target).closest(".fullscreen-menu-wrapper a").length && l.hasClass("fullscreen-menu-show") && (l.removeClass("fullscreen-menu-show"), i.removeClass("fullscreen-toggle-hide"))
    ...
    $(".search-toggle").on("click", function(a) {
        c.hasClass("search-wrapper-show") ? c.removeClass("search-wrapper-show") : c.addClass("search-wrapper-show"), a.stopPropagation()
    }), $(document).on("click", function(a) {
        0 === $(a.target).closest(".search-wrapper div[class^='col-']").length && c.hasClass("search-wrapper-show") && c.removeClass("search-wrapper-show")
    });
    var p = $(".navbar-fixed");
    $(window).on("scroll", function() {
        $(window).scrollTop() >= 10 ? p.addClass("navbar-shrink") : p.removeClass("navbar-shrink")
    });
    var u = $("html,body");
    ...
    var h = $(".scrolltotop");
    $(window).on("scroll", function() {
        $(this).scrollTop() > 700 ? h.addClass("scrolltotop-show") : h.removeClass("scrolltotop-show")
    }), h.on("click", function() {
        return u.animate({
            scrollTop: 0
    ...
    var v = $(".blog-masonry").imagesLoaded(function() {
            v.masonry({
                itemSelector: ".blog-post-box"
            })
        }),
        w = $(".masonry").imagesLoaded(function() {
            w.masonry({
    ...
    }), $('[data-toggle="popover"]').popover(), $('[data-toggle="tooltip"]').tooltip(), $(".pie-chart").appear(function() {
        $(this).each(function() {
            $(this).easyPieChart({
                lineCap: "square",
                onStep: function(a, e, o) {
    ...
    var f, C, b, k, y = $(".gmap");
    if (y.length)
        for (var x = 0; x < y.length; x++) b = (f = y[x]).dataset.latitude, k = f.dataset.longitude, C = "#" + f.id, new GMaps({
            el: C,
            lat: b,
            lng: k,
            zoom: 16,
